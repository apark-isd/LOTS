...
namespace LOTS3.Controllers
{
    ...
    //[Authorize(Policy = "CreateRolePolicy, EditRolePolicy, DeleteRolePolicy")]
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> EditRole(string id)
        {
            ...
            //https://www.aspsnippets.com/questions/188962/ASPNet-Core-MVC-Error-There-is-already-an-open-DataReader-associated-with-this-Connection-which-must-be-closed-first/
