...
namespace LOTS3.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            if(ModelState.IsValid)
            {
                ...
                if(result.Succeeded)
                {
                    ...
                    string NotificationBody = model.Email + ", EmpNo : " + empNo + ", " + empLName + ", " + empFName + " , a new account was created.";
                    IList<string> emailLists = new List<string>();
                    emailLists.Add("bramos@isd.lacounty.gov");
                    emailLists.Add("PSun@isd.lacounty.gov");
                    emailLists.Add("eshahverdian@isd.lacounty.gov");
                    emailLists.Add(model.Email);
                    var task = SendEmailAsync("ISD Parking Services", emailLists, "New Account", NotificationBody, null);
                    return RedirectToAction("index", "home");
                    //ViewBag.ErrorTitle = "Registration successful";
                    //ViewBag.ErrorMessage = "Befor you can login, please confirm your " +
        ...
        public async Task SendEmailAsync(string name, IList<string> toAddress, string subject, string body, IList<string> ccAddresses = null)
        {
            ...
            try
            {
                using (var client = new SmtpClient())
                {
                    ...
                    string emailHost = "mx2.hc4088-88.iphmx.com";
                    await client.ConnectAsync(emailHost, 587, useSsl: false);
                    string userId = "e521949";
                    string password = "Pad2023%";
            ...
            ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            ViewBag.ErrorMessage = "Please contact support on apark@isd.lacounty.gov";
            return View("Error");
        }
    }
}
